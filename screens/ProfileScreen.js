...
const ProfileScreen = () => {
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="h-40">
        <Image
          className="w-28 h-28 rounded-full mt-10 mx-auto"
      ...
      <View className="pb-4 px-4">
        ...
        <View className="border-b-2 border-gray-200 py-2">
          <Text className="text-sm font-light text-gray-500">Date of Birth</Text>
          <Text className="text-lg font-medium text-gray-700 mt-2">
            24 May 2003
          </Text>
        </View>
        <View className="py-2">
          ...
          <View className="flex flex-row flex-wrap bg-slate-100 rounded-md p-1 " >
              <Text className="bg-slate-600 text-white rounded-md m-1 px-2 py-1" >Gaurav</Text>
          </View>
        </View>
        <View className="py-2">
